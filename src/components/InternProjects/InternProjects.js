...
const slidesData = [
  {
    ...
    challenges:
      "Learning to accept imperfect solutions for smaller problems so that I could solve more problems overall and create a better final product was a skill that I had to develop as development dragged on. In three words? Learning to compromise.",
  ...
  },
  {
    ...
    challenges:
      "Development and integration of the three moving parts - the React frontend, Django backend and the NLP model - in the strict time constraint of a 24-hour hackathon proved to be challenging.",
    time: "72 hours",
  },
];
