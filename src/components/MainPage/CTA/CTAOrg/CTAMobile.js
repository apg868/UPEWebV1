...
function CTAMobile(){
    return(
        ...
        >
            ...
            >
                <VStack spacing="3em">
                    <Text color="white" fontSize="3xl" fontFamily="secondaryFont" fontWeight="medium">
                        Want to Join?
                    </Text>
                    ...
                    <Text color="white" fontSize="xl" fontFamily="secondaryFont" fontWeight="medium" maxWidth="50%" textAlign="center">
